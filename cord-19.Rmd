...
metadata <- read_csv("~/Downloads/2020-03-13/all_sources_metadata_2020-03-13.csv")
```

Extracting text from all the full papers

```{r}
json_objects <- dir("~/Downloads/2020-03-13/comm_use_subset/comm_use_subset/", full.names = TRUE) %>%
  map(read_json)
